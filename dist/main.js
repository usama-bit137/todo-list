...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _header__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./header */ \"./src/header.js\");\n/* harmony import */ var _sidebar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sidebar */ \"./src/sidebar.js\");\n/* harmony import */ var _todo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./todo */ \"./src/todo.js\");\n/* harmony import */ var _form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./form */ \"./src/form.js\");\n/* harmony import */ var _orderShow__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./orderShow */ \"./src/orderShow.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\n \n\n\n\n\n\n\n// generate the default page: \n(0,_header__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n(0,_sidebar__WEBPACK_IMPORTED_MODULE_1__.sidebarCreate)();\n(0,_sidebar__WEBPACK_IMPORTED_MODULE_1__.mainCreate)();\n(0,_form__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\n\nconst myTodo = [new _todo__WEBPACK_IMPORTED_MODULE_2__[\"default\"](\"homework\", \"untitled\", \"20:00\", \"12/12/2023\", \"high\"), new _todo__WEBPACK_IMPORTED_MODULE_2__[\"default\"](\"maths\", \"homework\", \"09:00\", \"12/02/2023\", \"high\"), new _todo__WEBPACK_IMPORTED_MODULE_2__[\"default\"](\"chem\", \"homework\", \"08:00\", \"12/02/2023\", \"high\"), new _todo__WEBPACK_IMPORTED_MODULE_2__[\"default\"](\"physics\", \"homework\", \"12:00\", \"12/03/2023\", \"high\"), new _todo__WEBPACK_IMPORTED_MODULE_2__[\"default\"](\"history\", \"homework\", \"10:00\", \"12/03/2023\", \"high\")];\nfor (let j = 0; j < myTodo.length; j++) {\n    myTodo[j].displayTodoMain();\n    myTodo[j].displaySidebar();\n}\nfunction creationEvent() {\n    const createButton = document.querySelector(\".create-todo\");\n    createButton.addEventListener(\"click\", () =>{\n        const title = document.getElementById(\"title-id\").value;\n        const project = document.getElementById(\"project-id\").value; \n        const date = document.getElementById(\"date-id\").value;\n        const time = document.getElementById(\"time-id\").value;\n        const priority = (0,_form__WEBPACK_IMPORTED_MODULE_3__.displayRadioValue)();\n        const newTodo = new _todo__WEBPACK_IMPORTED_MODULE_2__[\"default\"](title, project, time, date, priority);\n        myTodo.push(newTodo);\n        \n        newTodo.displaySidebar();\n        newTodo.displayTodoMain(); \n        console.log(myTodo);\n    })\n}\ncreationEvent();\n\n\n\nconst dateOrder = document.querySelector(\".date-order\");\ndateOrder.addEventListener(\"click\", () => { \n    const sideMain = document.querySelector(\".sideMain\");\n    sideMain.innerHTML = \" \";\n    (0,_sidebar__WEBPACK_IMPORTED_MODULE_1__.sidebarCreate)();\n    (0,_sidebar__WEBPACK_IMPORTED_MODULE_1__.mainCreate)();\n    (0,_form__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\n    \n    const dateOrderArray = (0,_orderShow__WEBPACK_IMPORTED_MODULE_4__.dateShow)(myTodo);\n    console.table(dateOrderArray);\n    // eslint-disable-next-line no-plusplus\n    for (let i = 0; i < dateOrderArray.length; i++) {\n        dateOrderArray[i].displayTodoMain(); \n        dateOrderArray[i].displaySidebar(); \n    }\n    creationEvent();\n})\n\n//# sourceURL=webpack://todo-list/./src/index.js?");
